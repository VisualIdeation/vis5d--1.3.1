 ...
 */
size_t free_isosurface( Context ctx, int time, int var )
{
   Display_Context dtx;
   int ctime, ftime, t;
   size_t total;
...
size_t free_textplot( Irregular_Context itx, int time)
{
...
size_t free_hslice( Context ctx, int time, int var )
{
  int i;
...
size_t free_vslice( Context ctx, int time, int var )
{
  int i;
...
size_t free_chslice( Context ctx, int time, int var )
{
...
size_t free_cvslice( Context ctx, int time, int var )
{
 ...
 */
size_t free_param_graphics( Context ctx, int var )
{
   int time;
...
size_t free_hwind( Display_Context dtx, int time, int ws )
{
   Context uctx;
...
size_t free_vwind( Display_Context dtx, int time, int ws )
{
   Context uctx;
...
size_t free_hstream( Display_Context dtx, int time, int ws )
{
   Context uctx;
...
size_t free_vstream( Display_Context dtx, int time, int ws )
{
 ...
 */
static size_t free_time( Context ctx, int time )
{
...
size_t i_deallocate_lru( Irregular_Context itx )
{
...
/*** deallocate_lru ***************************************************
   ...
   Return:  number of bytes freed or 0 if nothing found to deallocate.
**********************************************************************/
size_t deallocate_lru( Context ctx )
{
   int var, time, t, oldtime, oldig, oldvar;
   size_t bytes;
