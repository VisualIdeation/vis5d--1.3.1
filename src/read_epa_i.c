...
/* 01Feb06  Phil McDonald */
      gridlat = (float *) TMP_MALLOC (nr * nc * nl * sizeof (float));
      gridlon = (float *) TMP_MALLOC (nr * nc * nl * sizeof (float));
/* end PM */
...
/* 01Feb06  Phil McDonald */
      float *grid3d = (float *) TMP_MALLOC (nr * nc * nl * sizeof (float));
/* end PM */
      for (var=0;var<numvars;var++) {
...
/* 01Feb06  Phil McDonald */
         info->VarName = TMP_STRDUP (varname[var]);
/* end PM */
...
/* 01Feb06  Phil McDonald */
      if (temp) TMP_FREE (temp);
      temp = (float *) TMP_MALLOC (rows * columns * sizeof (float));
/* end PM */
...
/* 01Feb06  Phil McDonald */
      float *temp = (float *) TMP_MALLOC (size);
/* end PM */
      for (i=0; i<g->Nl/2 ;i++) {
