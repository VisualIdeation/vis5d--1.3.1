...
#ifdef HAVE_PTHREADS
extern int	sync_mutex_alloc (pthread_mutex_t *p_mutex,
		                  const pthread_mutexattr_t *p_mutex_attr);
extern int	sync_mutex_free (pthread_mutex_t *p_mutex);
extern int	sync_mutex_lock (pthread_mutex_t *p_mutex);
extern int	sync_mutex_unlock (pthread_mutex_t *p_mutex);

extern int	sync_mutex_set_funcs (
...
#  define ALLOC_LOCK( L )    sync_mutex_alloc ( &L, 0 )
#  define FREE_LOCK( L )     sync_mutex_free ( &L )
#  define LOCK_ON( L )       sync_mutex_lock ( &L )
#  define LOCK_OFF( L )      sync_mutex_unlock ( &L )
#endif
