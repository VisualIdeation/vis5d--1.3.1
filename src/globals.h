...
/* 16May06  Phil McDonald */
  int		lock;		/* mutual exclusion lock */
  int		itime;		/* timestep */
  int		ivar;		/* variable */
/* 11Aug06  Phil McDonald */
  void		*private_data;	/* private data for each rendering process */
/* 12Feb07  Phil McDonald */
  int		nx, ny, nz;	/* volume grid dims */
/* 15Feb07  Phil McDonald */
  int		nquad;		/* number of vertex quads */
  int		*qvert;		/* indices to verts for quads */
/* end PM */
};
...
/* 24Oct07  Phil McDonald */
   int    hires_maxverts;     /* max verts for hires topo */
   float  z_fuzz;             /* small offset to separate objects from topo */
/* end PM */
};
...
/* 25Oct07  Phil McDonald	volume dimensions */
...
/* 02Feb06  Phil McDonald */
   int		CaveMode;		/* 0 = not CAVE, 1 = CAVE */

/* 22Feb06  Phil McDonald	just for debugging */
   int		barf_lock;

/* 25Oct06  Phil McDonald		GL texture data */
   int		TexId;
/* end PM */
