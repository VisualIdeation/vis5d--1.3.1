...
/* 01Feb06  Phil McDonald */
  rPRIME = (float *) TMP_MALLOC (n * sizeof (float));
  cPRIME = (float *) TMP_MALLOC (n * sizeof (float));
  lPRIME = (float *) TMP_MALLOC (n * sizeof (float));
/* end PM */
...
/* 01Feb06  Phil McDonald */
  lat = (float *) TMP_MALLOC (n * sizeof (float));
  lon = (float *) TMP_MALLOC (n * sizeof (float));
  hgt = (float *) TMP_MALLOC (n * sizeof (float));
/* end PM */
