...
extern int init_irregular_memory( Irregular_Context itx, size_t bytes );

extern int i_init_shared_memory( Irregular_Context itx, void *start, size_t bytes );

extern int i_reinit_memory( Irregular_Context itx );

extern void *i_allocate( Irregular_Context itx, size_t bytes );

extern void *i_allocate_type( Irregular_Context itx, size_t bytes, int type );

extern void *i_pallocate( Irregular_Context itx, size_t bytes );

extern void i_deallocate( Irregular_Context itx, void *addr, size_t bytes );

extern size_t i_mem_available( Irregular_Context itx );
