...
extern size_t free_isosurface( Context ctx, int time, int var );

extern size_t free_textplot( Irregular_Context itx, int time);

extern size_t free_hslice( Context ctx, int time, int var );

extern size_t free_vslice( Context ctx, int time, int var );

extern size_t free_chslice( Context ctx, int time, int var );

extern size_t free_cvslice( Context ctx, int time, int var );

extern size_t free_param_graphics( Context ctx, int var );

extern size_t free_hwind( Display_Context dtx, int time, int ws );

extern size_t free_vwind( Display_Context dtx, int time, int ws );

extern size_t free_hstream( Display_Context dtx, int time, int ws );

extern size_t free_vstream( Display_Context dtx, int time, int ws );
...
extern size_t deallocate_lru( Context ctx );

extern size_t i_deallocate_lru( Irregular_Context itx );
