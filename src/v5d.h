...
/*				to accommodate 64-bit architectures     */
        size_t CurPos;              /* current position of file pointer */
        size_t FirstGridPos;        /* position of first grid in file */
        size_t GridSize[MAXVARS];   /* size of each grid */
        size_t SumGridSizes;        /* sum of GridSize[0..NumVars-1] */
/* end PM */
} v5dstruct;
...
extern size_t v5dSizeofGrid( const v5dstruct *v, int time, int var );
