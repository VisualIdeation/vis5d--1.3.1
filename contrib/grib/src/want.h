...
struct Want {
 ...
 int var_name[NVAR];	/* list of variable names correspinding to vars */
 ...
 int title[36];	/* output 3d gridfile title (use first 32 chars) */
 };
...
struct Ts {		/* time sorted & level sorted fields */
 ...
 int time;		/* the time for this time peroid as HHMMSS valid time */
 int serial;		/* Serial date */
