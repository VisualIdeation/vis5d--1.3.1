...
int x9ie32 (float a[], float b[], int n)
{
 union {
  ...
  float f;} rf;
 const int  infin  = 0x7F800000;
 const int  maskfr = 0x007FFFFF;
 const int  masksn = 0x7FFFFFFF;
 const int  mask21 = 0x00200000;
 const int  mask22 = 0x00400000;
 const int  mask23 = 0x00800000;
 const int  sign   = 0x80000000;

 int itemp;	/* hold current ibm 370 float */
 int ltemp;
 int isign;
 int ieeexp;	/* hold the derived ieee exponent */
 int k;
 int istat;
 int i;		/* indices */
